...
export const hero: Hero = {
  eyebrow: 'Агентство недвижимости в Москве и Московской области',
  title: 'Продадим вашу квартиру за 30 дней',
  titleNote: '— или подробно расскажем, почему сейчас не время продавать',
  subtitle:
    'Ведём каждую сделку индивидуально: за каждым клиентом закреплён личный агент, сопровождение от оценки до передачи ключей.',
  formLabel: 'Оставьте заявку — бесплатно оценим вашу квартиру',
