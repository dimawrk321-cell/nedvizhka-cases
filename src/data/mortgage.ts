...
/**
 * Банки-партнёры на странице ипотеки — тот же единый список из banks.ts, что и в профиле
 * Дарьи (14 банков). Логотипы банков — товарные знаки; выводим ТОЛЬКО текстовые названия.
 * TODO: заменить на официальные логотипы, когда получим брендбуки от банков.
 */
export const mortgageBanks: string[] = partnerBanks;
